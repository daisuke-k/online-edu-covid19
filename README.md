...
- パワポのスライド
  ...
  - 通信量は？
    - 経験上、Zoom だと、画面に動きがあまりないときは200kbps〜300kbps、画面が大きく変わるタイミングで最大1.5Mbpsぐらい。60分〜90分の同様の形態の会議（カメラの動画なし、スライドと音声のみ）にスマホで参加した際に通信量は200MB〜300MB程度。デバイス（スマホ、タブレット、PCなど）やディスプレイのサイズにより通信量が異なると考えられるので要検証。
- 音声・動画のみ
  - 通信量は？
- グループのディスカッション
  - breakout
